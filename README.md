...
- [Uncertainty Quantification in Federated Learning for Heterogeneous Health Data](https://openreview.net/forum?id=QSQOTUVQR46) 
- [Conformal Prediction for Federated Uncertainty Quantification Under Label Shift](https://arxiv.org/abs/2306.05131)
- [Federated Conformal Predictors for Distributed Uncertainty Quantification](https://arxiv.org/abs/2305.17564)
- [Federated Learning with Uncertainty via Distilled Predictive Distributions](https://arxiv.org/abs/2206.07562) 
- [Distribution-Free Federated Learning with Conformal Predictions](https://arxiv.org/abs/2110.07661) 
- [Fed-ensemble: Ensemble Models in Federated Learning for Improved Generalization and Uncertainty Quantification](https://arxiv.org/abs/2107.10663) 
- [FedUA: An Uncertainty-Aware Distillation-Based Federated Learning Scheme for Image Classification](https://www.researchgate.net/publication/369934371_FedUA_An_Uncertainty-Aware_Distillation-Based_Federated_Learning_Scheme_for_Image_Classification) 
- [Privacy Preserving Bayesian Federated Learning in Heterogeneous Settings](https://arxiv.org/abs/2306.07959)   
- [Self-Aware Personalized Federated Learning](https://arxiv.org/abs/2204.08069) 
- [No Fear of Heterogeneity: Classifier Calibration for Federated Learning with Non-IID Data](https://arxiv.org/abs/2106.05001) 
- [Cross-Silo Prototypical Calibration for Federated Learning with Non-IID Data](https://arxiv.org/abs/2308.03457) 
- [FedFA: Federated Learning with Feature Anchors to Align Features and Classifiers for Heterogeneous Data](https://arxiv.org/abs/2211.09299) 
- [Personalized Federated Learning via Variational Bayesian Inference](https://arxiv.org/abs/2206.07977)
- [FedPop: A Bayesian Approach for Personalised Federated Learning](https://arxiv.org/abs/2206.03611) 
- [Probabilistic Predictions with Federated Learning](https://www.mdpi.com/1099-4300/23/1/41) 


## Real World Applications
- [Federated learning enables big data for rare cancer boundary detection](https://www.nature.com/articles/s41467-022-33407-5) 
- [The Federated Tumor Segmentation (FeTS) Challenge](https://arxiv.org/abs/2105.05874)
